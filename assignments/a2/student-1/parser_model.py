...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        output_size=self.n_features*self.embed_size
        return torch.index_select(self.embeddings,0,w.flatten()).reshape(batch_size,output_size)
    ...
    def forward(self, w):
        ...
        return h_drop@self.hidden_to_logits_weight+self.hidden_to_logits_bias
        ### END YOUR CODE
